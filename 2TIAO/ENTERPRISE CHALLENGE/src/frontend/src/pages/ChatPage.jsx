...
/**
 * ChatPage — chat existente movido do App.jsx original (A1).
 * O comportamento é preservado 1:1; a extração para ChatWindow/MessageBubble
 * e o uso de usePacienteId acontecem na tarefa A5.
 */
export default function ChatPage() {
  ...
  return (
    <div className="mx-auto flex h-[75vh] w-full max-w-4xl flex-col overflow-hidden rounded-xl border border-gray-300 bg-white shadow-lg">
      ...
      {/* Área de Mensagens */}
      <div className="flex-1 overflow-y-auto bg-gray-50 p-6 shadow-inner">
        {mensagens.length === 0 ? (
          ...
          mensagens.map((msg, index) => (
            <div
              key={index}
              className={`mb-6 ${msg.remetente === 'paciente' ? 'text-right' : 'text-left'}`}
            >
              <div
