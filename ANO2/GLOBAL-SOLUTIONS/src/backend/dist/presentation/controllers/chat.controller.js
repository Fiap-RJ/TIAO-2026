...
let ChatController = class ChatController {
    constructor(processChatMessageUseCase) {
...
], ChatController.prototype, "handle", null);
exports.ChatController = ChatController = __decorate([
    (0, common_1.Controller)('api/chat'),
    __metadata("design:paramtypes", [process_chat_message_use_case_1.ProcessChatMessageUseCase])
], ChatController);
